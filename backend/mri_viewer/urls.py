...
urlpatterns = [
    ...
    path('pathology/pending-requests/', csrf_exempt(pathology_views.get_pending_requests), name='pathology-pending-requests'),
    path('pathology/update-status/<str:request_id>/', csrf_exempt(pathology_views.update_request_status), name='pathology-update-status'),
    path('pathology/complete-request/<str:request_id>/', csrf_exempt(pathology_views.complete_request), name='pathology-complete-request'),
    
    # 교육원 조원 요청 형식 API
    path('pathology/complete/', csrf_exempt(pathology_views.complete_task), name='pathology-complete'),
    path('pathology/fail/', csrf_exempt(pathology_views.fail_task), name='pathology-fail'),
]
